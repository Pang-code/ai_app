# 需求：用户会问到各种领域的问题(数学、物理，历史等)，根据不同的领域，定义不同的提示词模板，动态的选择合适的任务链路去完成。
#
...
# chain2 = RunnableSequence(steps=(chain1, route_runnable, router, StrOutputParser()))  #等价于下面的
